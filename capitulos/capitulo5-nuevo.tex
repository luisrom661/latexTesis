...
\begin{longtable}{
    |c|
    >{\raggedright\arraybackslash}p{\dimexpr\textwidth-2\tabcolsep-2\arrayrulewidth-1.8cm\relax}|
    }
    ...
    \hline
    P17          & ¿El modelo define con suficiente claridad los límites del rol del Social Guide, lo cual podría derivar en intervenciones excesivas o invasivas hacia el equipo?                                                                     \\
    \hline
    ...
    \hline
    P19          & ¿La sobrecarga de reuniones, métricas y responsabilidades adicionales que introduce SocialScrum resultaría sostenible para el equipo a mediano o largo plazo?                                                                       \\
    \hline
