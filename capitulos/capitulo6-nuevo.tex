...
\begin{enumerate}
    \item \textbf{Validación empírica en equipos reales:} Implementar SocialScrum en 3 a 5 equipos de desarrollo durante 6 a 12 meses, midiendo la evolución del Health Score, métricas técnicas (velocidad, defectos, rotación de personal) y satisfacción del equipo, con el fin de obtener evidencia empírica sobre su efectividad.
