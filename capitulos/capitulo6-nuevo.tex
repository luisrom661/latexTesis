...
Este objetivo se cumplió satisfactoriamente mediante el diseño del modelo SocialScrum, presentado en los capítulos~\ref{chap:capitulo3} y~\ref{chap:capitulo4}. SocialScrum constituye una extensión socio-técnica de Scrum que integra roles, eventos adaptados, artefactos sociales, métricas y salvaguardas éticas para la detección, análisis y mitigación de la deuda social en equipos de desarrollo de software. La validación mediante juicio de expertos (Capítulo~\ref{chap:capitulo5}) confirmó que el modelo es coherente con los principios ágiles, pertinente para las necesidades reales de los equipos y viable en su implementación.
...
\begin{enumerate}
   ...
   \item \textbf{Es posible integrar la gestión de la deuda social en Scrum sin comprometer la agilidad del proceso.} SocialScrum demostró que se pueden adaptar los eventos, artefactos y roles existentes de Scrum para incorporar una dimensión social, manteniendo una sobrecarga estimada inferior al 1\% del tiempo total del Sprint ($\sim$45 minutos por Sprint de dos semanas). La cobertura total de los 33 indicadores de AgilityPRO confirma esta alineación.
   ...
   \item \textbf{Las métricas sociales permiten objetivar un fenómeno tradicionalmente subjetivo.} El Health Score, basado en los cinco valores de Scrum, proporciona un indicador cuantificable y accionable del estado social del equipo, transformando las dinámicas interpersonales en datos gestionables que alimentan las decisiones de priorización.
...
\begin{enumerate}
   ...
   \item \textbf{Alcance de la Investigación-Acción:} Si bien el proyecto se estructuró bajo los ciclos de la Investigación-Acción aprobados en el anteproyecto \cite{baskerville1999actionresearch}, se reconoce que la validación se mantuvo en un plano conceptual y simulado. La ausencia de una intervención empírica en un entorno productivo real implica que los ciclos de diagnóstico, acción y reflexión se aplicaron de forma lineal y propositiva, centrados en la construcción y evaluación del artefacto metodológico (SocialScrum), y no como una intervención sociológica de campo. Por tanto, el uso del término Investigación-Acción en este trabajo debe entenderse como un marco de iteración para el diseño del modelo, cuya validación empírica completa queda definida como trabajo futuro.
...
\begin{enumerate}
   \item \textbf{Priorizar la validación empírica:} La principal recomendación para la comunidad académica es la realización de estudios de caso múltiples en organizaciones reales que permitan evaluar la efectividad de SocialScrum en diferentes contextos, tamaños de equipo e industrias.
