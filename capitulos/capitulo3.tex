...
\begin{longtable}[H]{
    ...
    >{\RaggedRight\hspace{0pt}}p{5.7cm}   % Facilitador
    }
...
\begin{longtable}{
    ...
    Declaraciones individuales en retrospectivas & Health Score promedio del equipo                                        \\ \midrule
    Conflictos interpersonales con nombres       & ``El equipo presenta aislamiento social'' (sin nombres)                 \\ \midrule
    Estado emocional de personas específicas     & ``Se detectó \textit{burnout} en el equipo'' (sin identificar personas) \\ \midrule
    Intención de renuncia de alguien             & ``Riesgo de rotación elevado'' (dato agregado)                          \\ \midrule
    Críticas a gerencia por persona              & ``El equipo reporta fricción con \textit{stakeholders}''                \\ \midrule
...
Una estrategia de mitigación consiste en que, durante las fases tempranas de adopción, la organización recurra a consultores externos ---psicólogos organizacionales o especialistas en recursos humanos con experiencia en equipos técnicos--- que acompañen y capaciten a un Scrum Master maduro para asumir progresivamente las funciones del Social Guide. De este modo, la barrera de entrada se reduce sin comprometer la calidad de la gestión social.
