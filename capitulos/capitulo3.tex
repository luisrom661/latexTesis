...
\begin{itemize}
    ...
    \item \textbf{Social Sprint Retrospective:} no requiere tiempo adicional; simplemente se re-equilibra el enfoque, pasando de una atención predominantemente técnica (90\%) a una distribución más equilibrada entre lo técnico y lo social (50\%-50\%).
\end{itemize}
