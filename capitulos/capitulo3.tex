...
Este capítulo introduce \glspl{socialscrum}, un proceso ágil que nace como una adaptación del marco Scrum, pensado especialmente para abordar la \gls{deuda-social} que suele surgir dentro de los equipos de desarrollo de software.
...
Es fundamental dejar claro lo que el Social Guide no hace:
...
Los ajustes sociales se incorporan respetando el \textbf{Principio de No-Sobrecarga} (más detalles en el Capítulo 4, Sección 4.10), que busca minimizar el impacto temporal de estas adaptaciones. A continuación, se describen las modificaciones específicas para cada evento:
...
La Tabla \ref{tab:eventos-tiempo} presenta una estimación del tiempo adicional (sobrecarga) que implican estas adaptaciones, evidenciando que el impacto temporal es mínimo en comparación con los beneficios obtenidos en cohesión, confianza y sostenibilidad del equipo.
