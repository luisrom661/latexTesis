...
Este capítulo introduce \gls{socialscrum}, un proceso ágil que nace como una adaptación del marco \gls{scrum}, pensado especialmente para abordar la \gls{deuda-social} que suele surgir dentro de los equipos de desarrollo de software.
...
Gracias a esta perspectiva, el Product Owner puede tomar decisiones de priorización más equilibradas y sostenibles, valorando no solo el impacto del producto en el negocio, sino también la salud y la estabilidad del equipo que lo hace posible.
...
\begin{itemize}
    \item \textbf{Identificación y análisis de olores comunitarios:} Detecta patrones como el aislamiento, la falta de cooperación o decisiones socio-técnicas poco informadas \cite{saeeda2024nontechnicaldebt}. Para ello, utiliza herramientas como el SNA y otras técnicas que ayudan a evaluar la salud de la comunidad de desarrollo.
...
\begin{longtable}{|
    ...
    Responsabilidad sobre salud emocional
                       ...
                       & Directa: detecta olores comunitarios, facilita mediaciones y monitorea el Health Score.                                               \\
    \hline

    Métricas que gestiona
                       & Velocidad, burndown, lead time, impedimentos técnicos.
                       & Health Score, Registro de olores comunitarios, \gls{social-story-points}.                                                             \\
    \hline
...
SocialScrum, por tanto, no añade nuevos eventos; en cambio, aprovecha los mismos espacios del marco Scrum para incluir en ellos una dimensión social.
...
\begin{longtable}[H]{|
    ...
    >{\RaggedRight\hspace{0pt}}p{11.3cm}|  % Adaptación en SocialScrum
    }
    ...
    El Social Guide comparte de forma breve la evolución de las métricas sociales —como SNA o distribución de conocimiento—, los olores comunitarios mitigados o nuevos, y cómo las interacciones influyeron en la entrega.
    ...
    Se convierte en el núcleo de la gestión social. El Social Guide lidera una sección específica (de 20 a 30 minutos) estructurada en cuatro fases: revisión del registro de olores comunitarios, análisis de causas raíz (por ejemplo, con la técnica de los \gls{five-whys}), diseño de experimentos de mejora con hipótesis comprobables y priorización de las acciones resultantes para el siguiente Sprint.
...
\begin{longtable}[H]{|
    >{\RaggedRight\hspace{0pt}}p{3.7cm}|   % Evento
    >{\Centering\hspace{0pt}}p{2.6cm}|     % Tiempo estimado
    >{\Centering\hspace{0pt}}p{2.7cm}|     % Sobrecarga social
    >{\RaggedRight\hspace{0pt}}p{5.9cm}|   % Facilitador
    }
    ...
    Social Sprint Retrospective
                    & 1.5 h
                    & +0 min\footnote{No se añade tiempo adicional, pero se redistribuye internamente: el enfoque pasa de 90~\% técnico a 50/50 técnico-social.}
...
\begin{longtable}[H]{|
    ...
    >{\RaggedRight\hspace{0pt}}p{11.5cm}|  % Adaptación en SocialScrum
    }
    ...
    Se amplía con elementos de Deuda Social o habilitadores de salud del equipo: iniciativas destinadas a mejorar la comunicación, reducir olores comunitarios persistentes o fortalecer las habilidades sociales del grupo (por ejemplo: ``Establecer protocolos de \textit{code review} no tóxicos para mitigar \gls{cs-priggish-members}'').
    El Product Owner los prioriza junto al Social Guide considerando cuatro criterios: el Health Score actual del equipo, la severidad del smell, el impacto en la velocidad y la viabilidad de mitigación \cite{saeeda2024nontechnicaldebt}.
    ...
    \textbf{Increment}       &
    Además de cumplir con la Definition of Done técnica, cada Increment se evalúa también por su impacto en la \gls{salud-social}.
    El Social Guide participa en la definición de criterios de sostenibilidad social, respondiendo preguntas como: ¿el trabajo se completó sin generar burnout? ¿sin crear nuevos olores comunitarios (por ejemplo, \gls{cs-black-cloud} por falta de documentación)? ¿mejoraron las dinámicas de colaboración?
    Se analizan indicadores como variaciones en el Health Score, aparición o reducción de olores comunitarios, distribución del conocimiento usando SNA o niveles de carga emocional (horas extra, rotación).
...
\begin{enumerate}
    \item \textbf{Registro de Community Smells:}
          Un registro centralizado donde se documentan los olores comunitarios detectados, junto con su fecha, categoría, nivel de severidad, estado actual, acciones tomadas y resultados obtenidos.
    ...
    \item \textbf{Dashboard de Métricas Sociales:}
          Una visualización en tiempo real de los principales indicadores de la salud del equipo: evolución del Health Score, distribución de conocimiento usando SNA, señales tempranas de burnout (por ejemplo, exceso de horas extra o variaciones en la velocidad individual), índice de seguridad psicológica (a partir de encuestas cada 2 o 3 Sprints) y equilibrio en la participación en la toma de decisiones.
          Estas métricas complementan la visión cualitativa del Social Guide, ayudando a detectar patrones o anomalías antes de que el problema escale, por ejemplo, un miembro que pasa de tener alta participación a permanecer en silencio.
...
Esta diferencia es crucial: identificar olores comunitarios implica un acto de vulnerabilidad voluntaria, no una respuesta condicionada por incentivos formales.

Pensémoslo así:

\begin{itemize}
    \item Los olores comunitarios no se identifican a través de \acrfull{kpi} tradicionales ni mediante sistemas de recompensas.
...
En SocialScrum, la autonomía se protege a través de la autoorganización genuina: los equipos deciden qué olores comunitarios priorizar, cómo diseñar sus estrategias de mitigación y qué compromisos sociales incorporar en el \textit{Social Sprint Backlog}.
...
Los \gls{community-smells} como \gls{cs-social-isolation}, \gls{cs-lone-wolf} o \gls{cs-toxic-relationships} son expresiones directas de esta carencia de relacionalidad.
...
\begin{itemize}
    \item Los olores comunitarios impactan tanto la confianza técnica —``¿puedo contar con que esta persona hará bien su trabajo?''— como la confianza social —``¿le importa genuinamente el bienestar del equipo?''—.
...
SocialScrum promueve el fortalecimiento de esta dimensión a través de prácticas como el pair programming, las sesiones de intercambio de conocimiento y la documentación accesible y compartida.
...
En el contexto de SocialScrum, la benevolencia se traduce en el valor de Respeto y en un conjunto de estrategias destinadas a contrarrestar el cinismo y la desconexión emocional, factores estrechamente relacionados con el \textit{burnout} \cite{tulili2022burnout}.
...
Por el contrario, olores comunitarios como Toxic Relationships o Priggish Members evidencian la erosión de esta dimensión, pues revelan entornos donde predomina la competencia egoísta, la desconfianza o la falta de empatía.
...
\begin{itemize}
    ...
    \item el cumplimiento verificable de los compromisos incluidos en el Social Sprint Backlog; y
...
Solo cuando existe confianza genuina —basada en integridad y benevolencia— pueden emerger conversaciones honestas sobre problemas interpersonales, lo que a su vez permite detectar y abordar olores comunitarios de raíz.
...
De ahí que olores comunitarios como Radio Silence o Organizational Silo resulten tan nocivos: interrumpen los flujos comunicativos y debilitan los lazos interpersonales que sostienen la colaboración y la confianza en equipos distribuidos.
...
\begin{itemize}
    ...
    \item Las estrategias para mejorar la confianza pueden diseñarse de forma más intencionada; por ejemplo, implementar sesiones de pair programming para reforzar la percepción de habilidad, o promover retrospectivas más abiertas y sinceras para fortalecer la benevolencia.
...
En este sentido, SocialScrum promueve la apertura al hacer visibles los olores comunitarios, las fricciones interpersonales y cualquier señal de deterioro en las relaciones, convirtiendo lo invisible en un punto de reflexión y mejora compartida.
...
Asimismo, el respeto actúa como un antídoto frente al lenguaje descortés y las relaciones tóxicas, factores que suelen detonar tanto el \textit{burnout} como la deuda social dentro de los equipos \cite{tulili2022burnout}.
...
En SocialScrum, este compromiso va más allá del cumplimiento técnico: implica una participación activa y genuina en la identificación y mitigación de los olores comunitarios, así como en el fortalecimiento del bienestar colectivo \cite{caballero2022communitysmells}.
...
\begin{longtable}[H]{|
    ...
    \textbf{Coraje}
                         & \gls{cs-sharing-villainy}, \gls{cs-lack-conflict-resolution}, \gls{cs-decision-incommunicability}, \gls{cs-newbie-ignored}, Radio Silence
                         & Comunicación y transparencia
                         & Social Sprint Retrospective como espacio protegido; modelado de liderazgo; canales seguros para expresar tensiones.                                                                                                                                                  \\
    \hline

    \textbf{Apertura}
                         & Radio Silence, Organizational Silo, \gls{cs-cognitive-distance}, Black Cloud, \gls{cs-information-island}, \gls{cs-missing-link}, \gls{cs-documentation-silo}
    ...
    \textbf{Respeto}
                         & Priggish Members, Lone Wolf, Social Isolation, Toxic Relationships, \gls{cs-power-holder}, \gls{cs-bottleneck}, \gls{cs-dismissiveness}, \gls{cs-unfriendly-environment}
    ...
    \textbf{Compromiso}
                         & \gls{cs-dissensus}, Solution Defiance, \gls{cs-prima-donnas}, Organizational Rigidity, \gls{cs-truck-factor}, \gls{cs-unhealthy-contribution}, \gls{cs-absent-stakeholder}, \gls{cs-disengagement}
    ...
    \textbf{Foco}
                         & \gls{cs-work-exhaustion}, \gls{cs-inefficacy}, Organizational Silo (intraequipo), Cognitive Distance, \gls{cs-overload}, \gls{cs-time-wasted}, \gls{cs-scattered-development}
...
\begin{longtable}[H]{|
    ...
    >{\RaggedRight\hspace{0pt}}p{6.0cm}|   % Función
...
De manera similar, Tulili et al. \cite{tulili2022burnout} evidenciaron que el \textit{burnout} presenta señales tempranas, pero solo son visibles si alguien las busca de forma sistemática.
...
\begin{itemize}
    ...
    \item Por Release, para observar tendencias sostenidas y riesgos de \textit{burnout}.
...
\begin{longtable}{|
    ...
    Por Release
                      ...
                      & Deterioro sostenido, patrones recurrentes, riesgo de \textit{burnout}
...
\begin{longtable}[H]{|
    ...
    >{\RaggedRight\hspace{0pt}}p{5.9cm}|   % Familias de intervención
    }
...
\begin{longtable}[H]{|
    ...
    >{\RaggedRight\hspace{0pt}}p{6.5cm}|   % Patrón de fallo
    ...
    \textbf{Inspección}
                               & \textit{Burnout} como desenlace no anticipado; escalamiento exponencial de los costos humanos y técnicos.
                               & Estudios muestran que el \textit{burnout} presentaba señales meses antes sin inspección continua \cite{tulili2022burnout}; detección tardía implica costos significativamente mayores \cite{dreesen2021socialdebt}.                               \\
    \hline

    \textbf{Adaptación}
                               & Intervenciones contraproducentes; persistencia de síntomas por aplicar soluciones superficiales.
                               & Acciones mal diseñadas que agravan el \textit{burnout} \cite{martini2019agiledebt}; community smells recurrentes no abordados desde su causa raíz \cite{caballero2022communitysmells}.                                                            \\
\end{longtable}
\endgroup
...
\begin{itemize}
    ...
    \item Información relacionada con el estado emocional, el agotamiento (\textit{burnout}) o la desmotivación de personas identificables.
...
\begin{itemize}
    ...
    \item Olores comunitarios generales, sin mencionar nombres ni casos específicos (``El equipo muestra señales de aislamiento social'').
...
La tabla~\ref{tab:confidencial-reportable-cap3} operacionaliza esta distinción con ejemplos concretos que el Social Guide debe aplicar en cada decisión de comunicación.
...
\begin{longtable}{|
    ...
    \caption{Información confidencial vs.\ reportable} \label{tab:confidencial-reportable-cap3}                            \\
    \hline
    \textbf{Confidencial (NO reportable)}        & \textbf{Reportable (datos agregados)}                                   \\
    \hline \endfirsthead
    \hline \endlastfoot
    Declaraciones individuales en retrospectivas & Health Score promedio del equipo                                        \\ \hline
...
El Social Guide reporta directamente al Scrum Master o, en su defecto, a los líderes técnicos (como el CTO o el VP de Ingeniería), pero nunca a Recursos Humanos (RR. HH.). Esta restricción existe para evitar conflictos de interés, ya que RR. HH. se encarga de evaluaciones de desempeño y decisiones laborales, precisamente los ámbitos donde está prohibido usar la información social.
...
\begin{itemize}
    ...
    \item \textbf{Nunca:} Social Guide $\rightarrow$ RR. HH. $\rightarrow$ Evaluaciones de desempeño
\end{itemize}
...
\begin{itemize}
    \item Qué tipo de información se recopilará (Health Score, olores comunitarios, reflexiones surgidas en las retrospectivas).
...
Esta arquitectura en capas permite que el modelo escale coherentemente desde los fundamentos teóricos (motivación, confianza y valores) hasta el impacto medible en la práctica (prevención de olores comunitarios, fortalecimiento de la cohesión, sostenibilidad y bienestar).
...
% TODO: Considerar la creación de un diagrama unificador (estilo Venn o flujo completo)
% que consolide las cuatro capas en una sola vista general, mostrando el ciclo Scrum
% tradicional con "capas superpuestas" o "puntos de control" sociales visibles
% (ej. el Health Score en la Review, los Social Items en el Planning, etc.).
% Esto complementaría las Figuras individuales por capa y ofrecería al lector
% una visión holística del flujo completo de SocialScrum en un solo vistazo.
...
Las herramientas y tecnologías que facilitan esta adaptación a diferentes contextos ---incluyendo configuraciones para distintas plataformas de gestión y plantillas operacionales--- se describen en el Capítulo~\ref{chap:capitulo4}, Sección~\ref{sec:herramientas-tecnologia-soporte}.

\section{Alcance y condiciones de aplicabilidad}
\label{sec:alcance-condiciones-aplicabilidad}

SocialScrum no pretende ser una solución universal.
Como todo marco de trabajo, opera bajo condiciones específicas que determinan su viabilidad.
Esta sección explicita los prerrequisitos organizacionales y las restricciones de diseño que delimitan el alcance del modelo; las limitaciones metodológicas de la investigación ---incluyendo la ausencia de validación empírica y la calibración de instrumentos--- se abordan en el Capítulo~\ref{chap:capitulo6}, Sección~\ref{sec:limitaciones}.

\paragraph{Prerrequisito de entorno organizacional mínimamente funcional.}
SocialScrum requiere un nivel base de funcionamiento organizacional para operar.
En entornos donde predominan la desconfianza sistémica, el abuso jerárquico o una comunicación totalmente fracturada, el modelo solo puede actuar de forma limitada: puede fomentar pequeños espacios de seguridad dentro de ciertos sub-equipos, pero no tiene la capacidad de erradicar la toxicidad organizacional desde la raíz.
Por tanto, la implementación debe focalizarse en aquellos equipos cuyo liderazgo esté genuinamente comprometido con el cambio, sin esperar que el modelo por sí solo transforme una cultura disfuncional.

\paragraph{Patrocinio ejecutivo como condición necesaria.}
El Social Guide solo puede desempeñar su labor de manera efectiva si cuenta con un respaldo real y explícito de los niveles ejecutivos (CTO, VP de Ingeniería, CEO).
Cuando la alta dirección no garantiza la confidencialidad de los reportes, no asigna recursos para intervenciones o usa la información con fines punitivos, el modelo pierde su base de confianza.
Las salvaguardas éticas descritas en la Sección~\ref{sec:salvaguardas_eticas} mitigan este riesgo, pero presuponen un compromiso ejecutivo que no puede ser sustituido por mecanismos internos del marco.

\paragraph{Tensiones operacionales inherentes.}
SocialScrum hace visibles conflictos estructurales que ya existen en la organización, pero no los elimina por sí mismo.
Dos tensiones merecen atención explícita como condiciones de diseño:

\begin{itemize}
    \item \textbf{Product Owner vs. Social Guide:} cuando el Product Owner exige ``entregar ya'' y el Social Guide alerta que el equipo está emocionalmente al límite, el modelo puede mostrar datos claros ---como un Health Score en estado crítico---, pero la decisión de priorizar el bienestar sobre la entrega depende de instancias de liderazgo que SocialScrum no controla.
    \item \textbf{Supervisión del Social Guide:} si el propio CTO que supervisa al Social Guide forma parte del problema, se genera un conflicto de interés que el marco no puede resolver internamente. En estos casos, el diseño contempla la escalación a niveles ejecutivos superiores o, como último recurso, a Recursos Humanos bajo garantías explícitas de no represalia.
\end{itemize}

\paragraph{Disponibilidad del perfil de Social Guide.}
El rol exige una combinación poco común de sensibilidad humana, rigor analítico y conocimiento técnico.
No todos los psicólogos organizacionales comprenden los entornos de desarrollo de software, ni todos los Scrum Masters tienen formación en dinámicas de grupo.
Como estrategia de mitigación, el modelo contempla que, durante las fases tempranas de adopción, la organización recurra a consultores externos ---psicólogos organizacionales o especialistas en recursos humanos con experiencia en equipos técnicos--- que acompañen y capaciten a un Scrum Master maduro para asumir progresivamente las funciones del Social Guide.
