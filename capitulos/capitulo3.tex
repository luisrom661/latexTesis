...
Finalmente, los \gls{feedback-loops} (representados con líneas discontinuas en la Figura~\ref{fig:arquitectura_integrada_final}) evidencian que el sistema es reflexivo: los resultados positivos retroalimentan los valores y principios que los generaron, haciendo que el ciclo empírico se auto-perfeccione de forma continua.
...
Las consideraciones más amplias sobre cómo escalar SocialScrum y adaptarlo a diferentes contextos se explican con mayor detalle en el Capítulo~\ref{chap:capitulo4}, Sección~\ref{sec:herramientas-tecnologia}: ``Escalabilidad y Adaptación de SocialScrum''.
