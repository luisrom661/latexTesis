...
\begin{longtable}[H]{
    ...
    >{\Centering\hspace{0pt}}p{3.2cm}     % Sobrecarga social
...
\begin{longtable}[H]{
    >{\RaggedRight\hspace{0pt}}p{2.6cm}   % Valor Scrum
...
\begin{longtable}[H]{
    >{\RaggedRight\hspace{0pt}}p{4.5cm}   % Estrategia
...
\begin{longtable}{
    ...
    >{\RaggedRight\hspace{0pt}}p{4.6cm}   % Fenómenos detectables
...
\begin{longtable}[H]{
    >{\RaggedRight\hspace{0pt}}p{4.0cm}   % Categoría
...
\begin{longtable}[H]{
    >{\RaggedRight\hspace{0pt}}p{4.0cm}   % Principio ausente
