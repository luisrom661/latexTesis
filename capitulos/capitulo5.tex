...
\begin{longtable}{
   ...
   E6           & Ingeniero en sistemas & 5 años                       & Ingeniero DevOps Senior               & Scrum, Kanban, SAFe                    \\
...
\begin{itemize}
   \item \textbf{Falta de ejemplos prácticos}: Algunos expertos señalaron la ausencia de ejemplos prácticos que ilustren la implementación del modelo en diferentes contextos.
...
\begin{itemize}
   \item \textbf{Incorporación de ejemplos prácticos}: Se recomendó incluir ejemplos prácticos que ilustren la implementación del modelo en diferentes contextos.
