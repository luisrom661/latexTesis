...
\begin{longtable}[H]{
   ...
   \toprule
   \textbf{Id.}                                                             & \textbf{Criterio}                  & \textbf{Pregunta}                                                                                                                                                                                                                                                                                       &
   \multicolumn{5}{c}{\textbf{Número de respuestas por nivel de la escala}} & \textbf{Desv. estándar ($\sigma$)}                                                                                                                                                                                                                                                                                                                                                                                                                 \\
   \cline{4-8}
...
\begin{longtable}{
   >{\Centering\hspace{0pt}}p{1.4cm}   % Pregunta
   ...
   >{\Centering\hspace{0pt}}p{3.0cm}   % Desv. Estándar
