...
La validación del modelo SocialScrum se fundamenta en un enfoque metodológico que busca contrastar la viabilidad conceptual y la pertinencia operativa del modelo. Dado que SocialScrum propone una extensión socio-técnica de Scrum, la estrategia de validación se centró en una evaluación técnica de contenido mediante el juicio de expertos, apoyada en cinco criterios de calidad fundamentales.

Con el fin de evaluar si SocialScrum constituye una propuesta viable más allá del plano teórico, el modelo se sometió a la evaluación de cinco criterios de calidad fundamentales detallados en la Sección~\ref{sec:criterios-evaluacion}. Estos criterios permiten medir aspectos clave como la claridad, completitud, idoneidad, facilidad de uso y agilidad del modelo. La evaluación se realiza a través de un instrumento estructurado que combina preguntas cerradas con escala Likert y preguntas abiertas para capturar tanto valoraciones cuantitativas como cualitativas. La dimensión de agilidad fue evaluada de forma independiente por los autores mediante el framework AgilityPRO, cuyo análisis se presenta en la Sección~\ref{sec:autoevaluacion-agilidad} del Capítulo~\ref{chap:capitulo4}.
...
Se definieron cinco criterios de evaluación clave para guiar la valoración del modelo SocialScrum por parte de los expertos mediante el instrumento de preguntas cerradas, cada uno con su respectiva descripción detallada (ver Tabla~\ref{tab:criterios-evaluacion}):
...
\begin{longtable}[H]{
   ...
   \toprule
   \textbf{Pregunta} & \textbf{Es5} & \textbf{Es4} & \textbf{Es3} & \textbf{Es2} & \textbf{Es1} & \textbf{Promedio ($\mu$)} & \textbf{Desv. Est. ($\sigma$)} & \textbf{CV (\%)} & \textbf{Interpretación CV} \\
   \midrule
   \endhead
   % --- 3. PIE PARA PÁGINAS INTERMEDIAS ---
   \midrule
   ...
   \endlastfoot
   % --- CONTENIDO ---
   P1                & 6            & 0            & 0            & 0            & 0            & 5,00                      & 0,00                           & 0,00             & Alta homogeneidad          \\
   P2                & 3            & 3            & 0            & 0            & 0            & 4,50                      & 0,50                           & 11,11            & Alta homogeneidad          \\
   P3                & 2            & 4            & 0            & 0            & 0            & 4,33                      & 0,47                           & 10,88            & Alta homogeneidad          \\
   P4                & 3            & 2            & 1            & 0            & 0            & 4,33                      & 0,75                           & 17,20            & Homogeneidad aceptable     \\
   P5                & 5            & 1            & 0            & 0            & 0            & 4,83                      & 0,37                           & 7,71             & Alta homogeneidad          \\
   P6                & 4            & 2            & 0            & 0            & 0            & 4,67                      & 0,47                           & 10,10            & Alta homogeneidad          \\
   P7                & 5            & 1            & 0            & 0            & 0            & 4,83                      & 0,37                           & 7,71             & Alta homogeneidad          \\
   P8                & 5            & 1            & 0            & 0            & 0            & 4,83                      & 0,37                           & 7,71             & Alta homogeneidad          \\
   P9                & 4            & 2            & 0            & 0            & 0            & 4,67                      & 0,47                           & 10,10            & Alta homogeneidad          \\
   P10               & 4            & 1            & 1            & 0            & 0            & 4,50                      & 0,76                           & 16,97            & Homogeneidad aceptable     \\
   P11               & 2            & 2            & 2            & 0            & 0            & 4,00                      & 0,82                           & 20,41            & Homogeneidad aceptable     \\
   P12               & 2            & 4            & 0            & 0            & 0            & 4,33                      & 0,47                           & 10,88            & Alta homogeneidad          \\
   P13               & 4            & 2            & 0            & 0            & 0            & 4,67                      & 0,47                           & 10,10            & Alta homogeneidad          \\
   P14               & 4            & 2            & 0            & 0            & 0            & 4,67                      & 0,47                           & 10,10            & Alta homogeneidad          \\
   P15               & 1            & 5            & 0            & 0            & 0            & 4,17                      & 0,37                           & 8,94             & Alta homogeneidad          \\
\end{longtable}
\endgroup
...
El análisis estadístico (ver Tabla~\ref{tab:sintesis_consenso}) reveló que la pregunta P1 obtuvo consenso total ($\sigma = 0{,}00$), con todos los expertos otorgando la máxima calificación, lo que valida la claridad conceptual de SocialScrum. La mayoría de las preguntas alcanzaron alto consenso ($\sigma \leq 0{,}50$), mientras que P4, P10 y P11 presentaron consenso aceptable ($0{,}50 < \sigma \leq 1{,}00$), señalando aspectos del modelo que, si bien son valorados positivamente, podrían beneficiarse de un refinamiento adicional, particularmente en lo relativo a la completitud general del modelo (P4), la viabilidad del perfil del Social Guide (P10) y la factibilidad de implementación sin cambios organizacionales impracticables (P11). No se registraron discrepancias ($\sigma > 1{,}00$) en ninguna de las preguntas evaluadas.
