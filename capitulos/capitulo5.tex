...
\begin{enumerate}
    ...
    \item \textbf{Criterios de evaluación considerados:} se detallan las dimensiones de calidad (claridad, completitud, idoneidad, facilidad de uso y agilidad) que guían el juicio de los expertos.
    ...
    \item \textbf{Trazabilidad con el framework AgilityPRO:} se expone la matriz de correspondencia que demuestra la cobertura de los 33 indicadores de agilidad dentro del instrumento diseñado.
    ...
    \item \textbf{Resultados de la validación y análisis cuantitativo:} se describen los métodos utilizados para analizar las respuestas obtenidas y se presentan los resultados estadísticos por criterio.
    \item \textbf{Desempeño del modelo y recomendaciones de mejora:} se integran los hallazgos cualitativos y la retroalimentación de los expertos para identificar fortalezas y debilidades.
\end{enumerate}
...
Se definieron cinco criterios de evaluación clave para guiar la valoración del modelo SocialScrum por parte de los expertos, cada uno con su respectiva descripción detallada (ver Tabla~\ref{tab:criterios-evaluacion}):
...
\begin{longtable}[H]{
    ...
    Agilidad
                      & Evalúa si los componentes del modelo (eventos, estimación y priorización) mantienen la alineación con los valores y principios del Manifiesto Ágil, garantizando un flujo de trabajo iterativo e incremental. \\
\end{longtable}
\endgroup

En cuanto al criterio relacionado con la agilidad de la Tabla \ref{tab:criterios-evaluacion}, este no se fundamenta en percepciones subjetivas, sino que tiene como propósito validar la pertinencia y el cumplimiento de los principios ágiles definidos en el framework AgilityPRO \cite{ortega2019agilityevaluation}.

Si bien el framework AgilityPRO define un total de 33 indicadores detallados (IA\_01 a IA\_33) para una auditoría exhaustiva de procesos, para efectos de este juicio de expertos se utilizó dicho framework como marco de referencia transversal para el diseño de todo el instrumento. De esta manera, los 33 indicadores no se limitan a una única sección, sino que fundamentan teóricamente las preguntas de múltiples dimensiones (Claridad, Completitud, Idoneidad, Facilidad de Uso y Agilidad), asegurando una validación integral de la alineación ágil del modelo. En la Sección \ref{sec:trazabilidad-agilitypro} se detalla la matriz de trazabilidad que evidencia esta cobertura metodológica.
...
preguntas cerradas fueron diseñadas para ser valoradas por los expertos en función de cinco criterios de calidad presentados anteriormente, utilizando la escala Likert (ver Sección~\ref{sec:escala-medicion}). Las preguntas abiertas permitieron a los expertos proporcionar comentarios cualitativos y sugerencias de mejora.
...
Para garantizar la rigurosidad metodológica y la alineación con los principios ágiles, se estableció una matriz de trazabilidad que vincula los 33 indicadores del framework AgilityPRO (IA\_01 a IA\_33) con las preguntas del instrumento de evaluación. Esta matriz demuestra que, aunque el cuestionario consta de 15 preguntas cerradas, su alcance cubre la totalidad de los indicadores de agilidad requeridos, distribuyéndolos transversalmente en las dimensiones evaluadas.
...
\begin{longtable}[H]{
    ...
    IA\_01       & Proceso iterativo e incremental          & P13               & Los eventos adaptados (Sprint Planning, Review) aseguran el ciclo iterativo. \\
    IA\_02       & Iteraciones duración máx. 1 mes          & P13               & Implícito en la estructura de Sprints de SocialScrum.                        \\
    IA\_03       & Iteración inicia al terminar anterior    & P13               & Continuidad asegurada por el ciclo de eventos.                               \\
    IA\_04       & Resultado versión funcional útil         & P15               & Equilibrio entre mejora social y entrega de valor.                           \\
    IA\_05       & Alcance negociable                       & P15               & Priorización socio-técnica flexible.                                         \\
    IA\_06       & Reunión diaria de progreso               & P13               & Social Daily Standup.                                                        \\
    IA\_07       & Duración limitada reunión diaria         & P13               & Diseño del Social Daily.                                                     \\
    IA\_08       & Actualización constante de requisitos    & P5, P15           & Social Product Backlog.                                                      \\
    IA\_09       & Requisitos actualizables siempre         & P15               & Adaptabilidad del backlog.                                                   \\
    IA\_10       & Autoorganización en tareas               & P10               & Competencias del equipo y Social Guide.                                      \\
    IA\_11       & Prioridad por riesgo                     & P15               & Priorización basada en riesgos sociales y técnicos.                          \\
    ...
    IA\_15       & Iteración cancelable                     & P13               & Mecanismos de gobernanza y revisión.                                         \\
    IA\_16       & Revisión de resultados al final          & P13               & Social Sprint Review.                                                        \\
    IA\_17       & Identificación de mejoras (Retro)        & P8, P13           & Social Sprint Retrospective y Health Score.                                  \\
    IA\_18       & Rol elimina impedimentos                 & P2, P9            & Social Guide gestiona deuda social (impedimento).                            \\
    IA\_19       & Cliente participa en priorización        & P15               & Priorización socio-técnica conjunta.                                         \\
    IA\_20       & Cliente en diseño de pruebas             & P15               & Validación de valor (implícito).                                             \\
    IA\_21       & Cliente elige tecnología                 & N/A               & Aspecto técnico fuera del alcance social, pero compatible.                   \\
    IA\_22       & Disponibilidad del cliente               & P13               & Fomento de interacción en eventos.                                           \\
    IA\_23       & Estimación por el equipo                 & P14               & Social Story Points (SSP).                                                   \\
    ...
    IA\_26       & Buen diseño (No duplicidad)              & P14               & Eficiencia en la estimación y trabajo.                                       \\
    ...
    IA\_29       & Integración continua                     & P13               & Integración de dinámicas sociales frecuentes.                                \\
...
(INFO DUMMY) La Tabla~\ref{tab:resultados-preguntas-agilidad} presenta los resultados específicos de las preguntas relacionadas con el criterio de agilidad. Este análisis permite evaluar en qué medida los expertos consideran que SocialScrum mantiene la esencia ágil, promoviendo la adaptabilidad, la entrega continua de valor y la mejora constante del equipo.
...
(INFO DUMMY) En el criterio de agilidad, como se observa en la Figura~\ref{fig:likert-agilidad}, las respuestas muestran una fuerte concentración en los niveles más altos de la escala (4 y 5). Esto indica que los expertos consideran que SocialScrum mantiene la esencia ágil, promoviendo la adaptabilidad, la entrega continua de valor y la mejora constante del equipo. Los eventos adaptados, el sistema de estimación y el mecanismo de priorización socio-técnica fueron particularmente bien valorados, reflejando su alineación con los principios ágiles del Manifiesto Ágil.
...
El análisis estadístico reveló discrepancias significativas en los indicadores P2, P13 y P15 (ver Tabla \ref{tab:sintesis_consenso}), lo cual señala áreas donde los expertos no coinciden plenamente y que SocialScrum debe priorizar para su refinamiento técnico. Se observa que los componentes evaluados en las preguntas P5 y P9 obtuvieron un consenso total ($\sigma = 0.00$), validando la solidez técnica de dichos procesos en SocialScrum. Por el contrario, la pregunta P15 presenta la mayor desviación estándar ($\sigma = 1.12$), lo que indica una disparidad de criterios entre los expertos y se identifica como una oportunidad de mejora crítica que requiere un ajuste en agilidad para lograr una mayor aceptación y efectividad del modelo.
