...
\begin{figure}[H]
   ...
   \begin{tikzpicture}
      \begin{axis}[
            xbar stacked,
            width=0.85\textwidth,
            height=4.5cm, % Ajustado para 3 preguntas (igual que Claridad)
            xlabel={Número de respuestas},
            xlabel style={
                  font=\normalsize,
                  yshift=-2pt % Espacio extra para que no se pegue a los números
               },
            ylabel={Preguntas},
            ylabel style={font=\normalsize},
            symbolic y coords={P15,P14,P13}, % Coordenadas específicas de Agilidad
            ytick=data,
            xtick={0,1,2,3,4,5,6},
            xticklabel style={font=\small},
            yticklabel style={font=\small},
            legend style={
                  at={(0.5,-0.45)}, % Espacio para que la leyenda no choque con el xlabel
                  anchor=north,
                  legend columns=3,
                  font=\scriptsize,
                  /tikz/every even column/.append style={column sep=0.3cm}
               },
            bar width=11pt, % Grosor fino consistente
            xmin=0, xmax=6,
            enlarge y limits=0.4, % Compacta las barras hacia el centro
            clip=false,
         ]
