\chapter*{ANEXO L: EJEMPLOS DETALLADOS DE INTERVENCIONES}
\addcontentsline{toc}{chapter}{ANEXO L: Ejemplos Detallados de Intervenciones}
...
\section*{L.1 Intervención: \textit{Radio Silence} (Smell de Comunicación)}
...
\section*{L.2 Intervención: Truck Factor = 1 (Smell de Conocimiento)}
...
\section*{L.3 Intervención: Conflicto No Resuelto (Smell Relacional)}
...
\section*{L.4 Intervención: Meeting Hell (Smell Organizacional)}
...
\section*{L.5 Experimento: Reducir Knowledge Islands}
