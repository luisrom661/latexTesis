\chapter*{ANEXO H: EJEMPLOS DETALLADOS DE INTERVENCIONES}
\addcontentsline{toc}{chapter}{ANEXO H: Ejemplos Detallados de Intervenciones}
...
\section*{H.1 Intervención: \textit{Radio Silence} (Smell de Comunicación)}
...
\section*{H.2 Intervención: Truck Factor = 1 (Smell de Conocimiento)}
...
\section*{H.3 Intervención: Conflicto No Resuelto (Smell Relacional)}
...
\section*{H.4 Intervención: Meeting Hell (Smell Organizacional)}
...
\section*{H.5 Experimento: Reducir Knowledge Islands}
