\chapter*{ANEXO D: CONSENTIMIENTO INFORMADO DEL EQUIPO PARA SOCIALSCRUM}
\label{anexo:consentimiento}
\addcontentsline{toc}{chapter}{ANEXO D: Consentimiento Informado del Equipo para SocialScrum}
...
\begin{itemize}
    ...
    \item \textbf{Gestionar \textit{community smells}} (patrones de comportamiento disfuncionales) mediante ciclos continuos de transparencia, inspección y adaptación.
...
\begin{itemize}
    ...
    \item \textbf{\textit{Community smells}}: patrones disfuncionales detectados a nivel de equipo (no individual), como \textit{Radio Silence}, \textit{Lone Wolf}, \textit{Black Cloud}, entre otros.
\end{itemize}

\subsubsection*{2.2. Información cualitativa}

\begin{itemize}
    \item \textbf{Comentarios en eventos sociales}: Aportes realizados durante Social Daily Standup, Social Sprint Retrospective o sesiones de mediación.
...
\begin{itemize}
    \item \textbf{Mejoras internas}: Identificar \textit{community smells}, diseñar intervenciones y medir su impacto.
...
\begin{itemize}
    ...
    \item \textbf{El equipo completo} tendrá acceso a reportes agregados (Health Score, \textit{community smells}, acciones de mitigación).
