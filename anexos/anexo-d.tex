...
\noindent
Yo, \underline{\hspace{6cm}} (nombre completo del miembro del equipo),\\[0.3cm]
en mi rol de \underline{\hspace{5cm}} (rol en el equipo: Developer, QA, etc.),\\[0.3cm]
en el equipo \underline{\hspace{5cm}} (nombre del equipo),\\[0.3cm]
declaro que he recibido una explicación clara y completa sobre la implementación del marco \gls{socialscrum}.

\subsection{Comprensión del propósito de SocialScrum}
Entiendo que SocialScrum es un proceso ágil orientado a:

\begin{itemize}
    \item \textbf{Identificar, priorizar y mitigar la \gls{deuda-social}} del equipo, entendida como decisiones socio-técnicas que afectan nuestra productividad, calidad del software y cohesión interna.
...
\begin{itemize}
    \item \textbf{\gls{health-score}}: Medición periódica (por Sprint) de los cinco valores de \gls{scrum} —Apertura, Compromiso, Respeto, Foco y Coraje— con una escala de 1 a 10.
    \item \textbf{Métricas sociales agregadas}: Patrones de comunicación, distribución del conocimiento (\gls{sna}), señales de \gls{burnout} (horas extra, cambios abruptos en la velocidad), etc.
    \item \textbf{Olores comunitarios}: Patrones disfuncionales detectados a nivel de equipo (no individual), como \gls{cs-radio-silence}, \gls{cs-lone-wolf}, \gls{cs-black-cloud}, entre otros.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Entrevistas 1:1 opcionales}: Conversaciones privadas con el \gls{social-guide} para profundizar en temas relevantes.
...
\begin{itemize}
    \item \textbf{Mejoras internas}: Identificar olores comunitarios, diseñar intervenciones y medir su impacto.
...
\begin{itemize}
    ...
    \item \textbf{El equipo completo} tendrá acceso a los reportes agregados (Health Score, olores comunitarios, acciones de mitigación).
