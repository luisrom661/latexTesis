...
\begin{itemize}
    ...
    \item Se logra mitigar parcialmente al menos un Olor Comunitario crítico.
    \item La velocidad no cae más del 20\% en el proceso de adopción y muestra señales de recuperación en el Sprint 3.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Contenido:}
          \begin{itemize}
              \item \textbf{Sesión 1: \acrfull{tad} (2h)}
                    \begin{itemize}
              ...
              \item \textbf{Sesión 2: Confianza Mayer (2h)}
                    ...
                    \end{itemize}
              \item \textbf{Sesión 3: \gls{community-smells} (2h)}
                    \begin{itemize}
...
\begin{table}[!htbp]
    ...
    \begin{tabularx}{\textwidth}{|X|c|X|X|}
        ...
        Dependencia única de Miguel en el backend
                                     ...
                                     & \gls{pair-programming} dos horas al día con Laura para transferencia de conocimiento.                                                             \\
        \hline
...
\begin{table}[!htbp]
    ...
    \begin{tabularx}{\textwidth}{|X|c|X|}
        ...
        \hline
        \gls{community-smells} abordados
                          & 3 min
...
Selección de 2-3 temas prioritarios mediante la votación por puntos. Análisis de causa raíz con \gls{five-whys} adaptados a contexto social. El Social Guide redirige señalamientos de culpables hacia condiciones sistémicas. Mapeo a \gls{community-smells} del catálogo cuando corresponda.
