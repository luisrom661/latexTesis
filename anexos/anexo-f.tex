\chapter*{ANEXO F: EJEMPLOS DETALLADOS DE INTERVENCIONES}
\addcontentsline{toc}{chapter}{ANEXO F: Ejemplos Detallados de Intervenciones}
\label{anexo:ejemplos-intervenciones}

Este anexo presenta ejemplos detallados de intervenciones para diferentes categor\'ias de community smells. Cada ejemplo incluye diagn\'ostico, estrategia paso a paso, m\'etricas de \'exito y resultados observados.

\section*{F.1 Intervenci\'on: Radio Silence (Smell de Comunicaci\'on)}
...
\section*{F.2 Intervenci\'on: Truck Factor = 1 (Smell de Conocimiento)}
...
ESTRATEGIA (8 SPS distribuidos en 3 Sprints):
...
\section*{F.3 Intervenci\'on: Conflicto No Resuelto (Smell Relacional)}
...
\section*{F.4 Intervenci\'on: Meeting Hell (Smell Organizacional)}
...
- Auditoría de calendarios muestra:
  ...
  - 10h/semana: reuniones con stakeholders (excesivo)
...
\section*{F.5 Experimento: Reducir Knowledge Islands}
